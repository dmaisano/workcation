  ...
  <header class="bg-gray-900">
    ...
    <nav v-show="isOpen">
      <div class="px-2 pt-2 pb-5 border-b border-gray-800">
        <a
          href="#"
          class="block px-3 py-1 rounded leading-tight font-semibold text-white hover:bg-gray-800"
        >List your property</a>
        <a
          href="#"
          class="mt-1 block px-3 py-1 rounded leading-tight font-semibold text-white hover:bg-gray-800"
        >Trips</a>
        <a
          href="#"
          class="mt-1 block px-3 py-1 rounded leading-tight font-semibold text-white hover:bg-gray-800"
      ...
      <div class="px-5 py-5">
        <div class="flex items-center">
          ...
          />
          <span class="ml-2 font-semibold text-gray-200">Isla Schoger</span>
        </div>
        <div class="mt-5">
          <a href="#" class="block leading-tight hover:bg-gray-800 text-gray-400">Account Settings</a>
          <a href="#" class="mt-3 block leading-tight hover:bg-gray-800 text-gray-400">Support</a>
          <a href="#" class="mt-3 block leading-tight hover:bg-gray-800 text-gray-400">Sign Out</a>
        </div>
      </div>
    </nav>
  </header>
